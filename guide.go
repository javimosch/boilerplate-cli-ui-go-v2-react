...
func guideJSON() string {
	g := map[string]any{
		"boilerplate-cli-ui-go-v2-react": "A Go CLI with an embedded React web UI, compiled to a single binary.",
		"version":                  Version,
		...
		"loop": []string{
			...
			"./boilerplate-cli-ui-go-v2-react serve — foreground on 127.0.0.1:8080",
			"open http://127.0.0.1:8080/ for the UI, or curl /api/status for JSON",
			"./boilerplate-cli-ui-go-v2-react daemon start — background it instead",
			"./boilerplate-cli-ui-go-v2-react daemon stop — stop it",
		},
		...
		"commands": map[string][]string{
			"server": {
				"boilerplate-cli-ui-go-v2-react serve [--host H] [--port N]",
				"boilerplate-cli-ui-go-v2-react daemon start [--port N]",
				"boilerplate-cli-ui-go-v2-react daemon stop [--port N]",
				"boilerplate-cli-ui-go-v2-react daemon status [--port N]",
			},
			"introspection": {
				"boilerplate-cli-ui-go-v2-react guide [--human]",
				"boilerplate-cli-ui-go-v2-react help-json",
				"boilerplate-cli-ui-go-v2-react version [--json]",
			},
		},
		"examples": []map[string]any{
			{"goal": "serve the UI on a custom port", "do": []string{"./boilerplate-cli-ui-go-v2-react serve --port 3000"}},
			{"goal": "background it and confirm it is up", "do": []string{
				"./boilerplate-cli-ui-go-v2-react daemon start --port 3000",
				"./boilerplate-cli-ui-go-v2-react daemon status --port 3000",
			}},
			{"goal": "expose it on the LAN with a kill switch that needs a token", "do": []string{
				"SHUTDOWN_TOKEN=s3cret ./boilerplate-cli-ui-go-v2-react serve --host 0.0.0.0 --port 8080",
			}},
		},
		"gotchas": []string{
...
func guideMarkdown() string {
	return `# boilerplate-cli-ui-go-v2-react
...
1. ` + "`./build.sh`" + `
2. ` + "`./boilerplate-cli-ui-go-v2-react serve`" + `
3. Open http://127.0.0.1:8080/ or curl /api/status.
4. ` + "`./boilerplate-cli-ui-go-v2-react daemon start`" + ` to background it.
5. ` + "`./boilerplate-cli-ui-go-v2-react daemon stop`" + ` to stop it.
...
## Drive it
    ...
    boilerplate-cli-ui-go-v2-react serve [--host H] [--port N]
    boilerplate-cli-ui-go-v2-react daemon start|stop|status [--port N]

JSON on stdout, context on stderr, exit 0/80-119.

## Learn it

    boilerplate-cli-ui-go-v2-react guide      # embedded, JSON
    boilerplate-cli-ui-go-v2-react help-json  # command catalog
...
func helpJSON() string {
	c := map[string]any{
		"version":      "1.0",
		"tool":         "boilerplate-cli-ui-go-v2-react",
		...
		"see_also": []string{"boilerplate-cli-ui-go-v2-react guide", "https://cli-specs.intrane.fr"},
	}
